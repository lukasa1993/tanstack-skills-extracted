...
- See also: `../tanstack-ai-core-chat-experience/SKILL.md` -- Adapter choice affects chat setup
- See also: `../tanstack-ai-core-structured-outputs/SKILL.md` -- `outputSchema` handles provider differences transparently
