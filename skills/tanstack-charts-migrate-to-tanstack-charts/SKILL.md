---
name: tanstack-charts-migrate-to-tanstack-charts
description: "Migrate Observable Plot, Recharts, Chart.js, ECharts, direct D3, or another renderer to TanStack Charts by translating semantic ownership and proving visual, interaction, accessibility, export, bundle, and performance parity."
license: "MIT"
metadata:
  internal: true
...
See also: `../tanstack-charts-design-a-chart/SKILL.md` and `../tanstack-charts-debug-and-verify-charts/SKILL.md` — restate the analytical task and prove parity beyond screenshots.
