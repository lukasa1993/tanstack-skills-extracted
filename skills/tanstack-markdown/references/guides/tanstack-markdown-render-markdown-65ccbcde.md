...
accepted bundle cost. See `./tanstack-markdown-production-pipelines-dc3fb9bc.md#source-tanstack-markdown-production-pipelines` for compatibility,
...
See also: `./tanstack-markdown-production-pipelines-dc3fb9bc.md#source-tanstack-markdown-production-pipelines` - compatibility breadth must be
...
See also: `./tanstack-markdown-production-pipelines-dc3fb9bc.md#source-tanstack-markdown-production-pipelines` - parse-ahead caching must preserve
...
See also: `./tanstack-markdown-custom-extensions-0739b840.md#source-tanstack-markdown-custom-extensions` - parser and transform extensions must
...
- `./tanstack-markdown-production-pipelines-dc3fb9bc.md#source-tanstack-markdown-production-pipelines` - trust boundaries, syntax highlighting,
  practical compatibility, caching, tests, performance, and bundle budgets.
- `./tanstack-markdown-react-rendering-65b773b4.md#source-tanstack-markdown-react-rendering` - render the same source or AST as React nodes.
- `./tanstack-markdown-octane-rendering-821e3074.md#source-tanstack-markdown-octane-rendering` - render the same source or AST as Octane nodes.
- `./tanstack-markdown-custom-extensions-0739b840.md#source-tanstack-markdown-custom-extensions` - add deterministic parser and renderer hooks.
- `./tanstack-markdown-docs-features-62c13998.md#source-tanstack-markdown-docs-features` - use the first-party documentation extensions.
