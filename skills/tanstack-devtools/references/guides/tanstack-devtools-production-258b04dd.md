...
Prerequisite: [Devtools App Setup](./tanstack-devtools-app-setup-a09047cc.md).

## Choose a section

Read the overview or setup when it is a prerequisite, then the section needed for the task.

- [Overview](./tanstack-devtools-production-258b04dd--overview.md) — 1 KiB
- [How Production Stripping Works](./tanstack-devtools-production-258b04dd--how-production-stripping-works.md) — 3 KiB
...
- [Key Source Files](./tanstack-devtools-production-258b04dd--key-source-files.md) — 1 KiB

<!-- Original source anchors retained for inbound links. -->
<a id="tanstack-devtools-production-handling"></a>
<a id="how-production-stripping-works"></a>
<a id="mechanism-1-vite-plugin-auto-stripping-vite-projects"></a>
<a id="mechanism-2-conditional-exports-packagejson"></a>
<a id="the-two-workflows"></a>
<a id="development-only-workflow-default-recommended"></a>
<a id="production-workflow-intentional"></a>
<a id="non-vite-projects"></a>
...
<a id="medium-not-using-noop-variants-in-plugin-libraries"></a>
<a id="design-tension"></a>
