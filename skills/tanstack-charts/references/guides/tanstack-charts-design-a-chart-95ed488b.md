...
See also: `./tanstack-charts-prepare-chart-data-b0946b81.md#source-tanstack-charts-prepare-chart-data` § Common Mistakes

## References

- [Analytical task and visual-form matrix](../assets/tanstack-charts-design-a-chart/references/visual-task-matrix.md)

See also: `./tanstack-charts-prepare-chart-data-b0946b81.md#source-tanstack-charts-prepare-chart-data` and `./tanstack-charts-compose-marks-and-views-9437b112.md#source-tanstack-charts-compose-marks-and-views` — the analytical task determines both the transform and mark composition.
