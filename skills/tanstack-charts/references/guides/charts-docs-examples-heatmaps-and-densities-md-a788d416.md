...
[Data and Channels](./charts-docs-concepts-data-and-channels-md-e25a7b78.md#source-charts-docs-concepts-data-and-channels-md) explains interval and
color channels. [Legends and Color](./charts-docs-guides-legends-and-color-md-715f4e34.md#source-charts-docs-guides-legends-and-color-md) covers
...
[Scales](./charts-docs-concepts-scales-and-d3-md-690870a4.md#source-charts-docs-concepts-scales-and-d3-md) for binning and scale ownership.
...
The optional [`contour` mark](./charts-docs-reference-marks-contour-md-76f842db.md#source-charts-docs-reference-marks-contour-md) accepts the raw
...
[`densityContour` mark](./charts-docs-reference-marks-density-md-a4d4a2ed.md#source-charts-docs-reference-marks-density-md) maps the source channels
...
layout. The optional [`hexbin` mark](./charts-docs-reference-marks-hexbin-md-aeb4ac1c.md#source-charts-docs-reference-marks-hexbin-md) owns that
...
- Add direct labels only when cells remain large enough to read. A labeled
  ...
  [Themes and Styling](./charts-docs-guides-themes-and-styling-md-d4e17373.md#source-charts-docs-guides-themes-and-styling-md).
- Prefer aggregation over rendering an unbounded raw point layer. See
  [Large Data](./charts-docs-guides-large-data-md-937914ac.md#source-charts-docs-guides-large-data-md).
