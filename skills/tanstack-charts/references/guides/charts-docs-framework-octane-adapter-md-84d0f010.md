...
[Scales](./charts-docs-concepts-scales-and-d3-md-690870a4.md#source-charts-docs-concepts-scales-and-d3-md) for injected primitives and
the [core API reference](./charts-docs-reference-index-md-6fc2c6fc.md#source-charts-docs-reference-index-md) for marks, interaction,
