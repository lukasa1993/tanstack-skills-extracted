...
The transform contract is defined in [Data Transforms](./charts-docs-reference-transforms-md-6acdd0ab.md#source-charts-docs-reference-transforms-md),
...
- Use a legend or direct labels that remain meaningful in light and dark
  themes. See [Legends and Color](./charts-docs-guides-legends-and-color-md-715f4e34.md#source-charts-docs-guides-legends-and-color-md).
...
[Marks and Layering](./charts-docs-concepts-marks-and-layering-md-cbd6c26d.md#source-charts-docs-concepts-marks-and-layering-md) explains how the
