...
See [Rules, Links, Arrows, Vectors, and Ticks](./charts-docs-reference-marks-rules-links-arrows-vectors-and-ticks-md-364694cb.md#source-charts-docs-reference-marks-rules-links-arrows-vectors-and-ticks-md)
for link curves and paint, and
[Networks and Hierarchies](./charts-docs-examples-networks-and-hierarchies-md-d4abeb30.md#source-charts-docs-examples-networks-and-hierarchies-md) for the
catalog cases.
