...
Start at [Choosing a Chart](./charts-docs-guides-choosing-a-chart-md-c305fbfb.md#source-charts-docs-guides-choosing-a-chart-md), then use the relevant
[example family](./charts-docs-examples-index-md-af22062f.md#source-charts-docs-examples-index-md).
...
- grammar and channel semantics:
  [Grammar of Graphics](./charts-docs-concepts-grammar-of-graphics-md-3b814e73.md#source-charts-docs-concepts-grammar-of-graphics-md);
...
- exact signatures and options:
  [API Reference](./charts-docs-reference-index-md-6fc2c6fc.md#source-charts-docs-reference-index-md).
