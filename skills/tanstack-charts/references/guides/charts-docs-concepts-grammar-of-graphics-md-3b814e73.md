...
mappings. [Scales](./charts-docs-concepts-scales-and-d3-md-690870a4.md#source-charts-docs-concepts-scales-and-d3-md) explains when a chart needs D3 instead.
...
If a transform creates new rows, run that transform before the mark. Memoize expensive derived rows through application or framework reactivity. See [Chart Definitions](./charts-docs-concepts-chart-definitions-md-fe2aa9fa.md#source-charts-docs-concepts-chart-definitions-md).
...
Choose a mark for the analytical task, then layer other marks to add context. [Marks and Layering](./charts-docs-concepts-marks-and-layering-md-cbd6c26d.md#source-charts-docs-concepts-marks-and-layering-md) describes the built-in families.
...
Read [Data and Channels](./charts-docs-concepts-data-and-channels-md-e25a7b78.md#source-charts-docs-concepts-data-and-channels-md) for missing values, accessors, keys, grouping, color, and radius.
...
Omitted margins are measured from the actual guides. See [Layout, Axes, and Coordinates](./charts-docs-concepts-layout-axes-and-coordinates-md-371d3a9a.md#source-charts-docs-concepts-layout-axes-and-coordinates-md).
...
Continue with [Chart Definitions](./charts-docs-concepts-chart-definitions-md-fe2aa9fa.md#source-charts-docs-concepts-chart-definitions-md), or start from a task in [Choosing a Chart](./charts-docs-guides-choosing-a-chart-md-c305fbfb.md#source-charts-docs-guides-choosing-a-chart-md).
