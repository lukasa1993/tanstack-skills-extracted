...
See also: `./tanstack-charts-design-a-chart-95ed488b.md#source-tanstack-charts-design-a-chart` § Common Mistakes

## References

- [Transform selection and output contracts](../assets/tanstack-charts-prepare-chart-data/references/transforms.md)

See also: `./tanstack-charts-configure-scales-guides-color-2708fed7.md#source-tanstack-charts-configure-scales-guides-color`, `./tanstack-charts-build-chart-interactions-e6508ffb.md#source-tanstack-charts-build-chart-interactions`, and `./tanstack-charts-coordinate-charts-with-tanstack-c02cf542.md#source-tanstack-charts-coordinate-charts-with-tanstack` — derived values determine domains, legends, tooltip content, available lineage, and shared chart-grid projections.
