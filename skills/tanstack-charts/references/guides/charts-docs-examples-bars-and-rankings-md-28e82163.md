...
| How do subgroups contribute to each category?                     | Grouped or stacked bars in [Stacked and Composed Charts](./charts-docs-examples-stacked-and-composition-md-e79a97ca.md#source-charts-docs-examples-stacked-and-composition-md) |

Use horizontal bars when labels are long or when the rank itself should read
top to bottom. [Layout, Axes, and Coordinates](./charts-docs-concepts-layout-axes-and-coordinates-md-371d3a9a.md#source-charts-docs-concepts-layout-axes-and-coordinates-md)
...
defines the link channels; [Dot and Hexagon Marks](./charts-docs-reference-marks-dot-and-hexagon-md-df946606.md#source-charts-docs-reference-marks-dot-and-hexagon-md)
...
is described in [Scales](./charts-docs-concepts-scales-and-d3-md-690870a4.md#source-charts-docs-concepts-scales-and-d3-md), and the geometry
contracts are in [Bar and Rect Marks](./charts-docs-reference-marks-bar-and-rect-md-ba5b9a5c.md#source-charts-docs-reference-marks-bar-and-rect-md).
