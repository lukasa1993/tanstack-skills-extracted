...
See also: `./tanstack-charts-ship-accessible-charts-94d273f3.md#source-tanstack-charts-ship-accessible-charts` and `./tanstack-charts-extend-tanstack-charts-7d59a379.md#source-tanstack-charts-extend-tanstack-charts`

## References

- [Interaction ownership and state machines](../assets/tanstack-charts-build-chart-interactions/references/interaction-state.md)

See also: `./tanstack-charts-coordinate-charts-with-tanstack-c02cf542.md#source-tanstack-charts-coordinate-charts-with-tanstack`, `./tanstack-charts-ship-accessible-charts-94d273f3.md#source-tanstack-charts-ship-accessible-charts`, and `./tanstack-charts-update-and-animate-charts-7f17ca0c.md#source-tanstack-charts-update-and-animate-charts` — interaction requires explicit cross-surface ownership, keyboard parity, and stable identity across updates.
