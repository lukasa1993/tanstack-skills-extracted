...
See also: `./tanstack-charts-build-chart-interactions-e6508ffb.md#source-tanstack-charts-build-chart-interactions` and `./tanstack-charts-extend-tanstack-charts-7d59a379.md#source-tanstack-charts-extend-tanstack-charts` — layering determines point ownership, and native composition should be exhausted before extension.
