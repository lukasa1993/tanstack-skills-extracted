...
Read [Dynamic Data and Animation](./charts-docs-guides-dynamic-data-and-animation-md-f2a556c9.md#source-charts-docs-guides-dynamic-data-and-animation-md) and
the [Motion reference](./charts-docs-reference-motion-md-125c7e38.md#source-charts-docs-reference-motion-md) for update and timing contracts.
...
Read [Themes and Styling](./charts-docs-guides-themes-and-styling-md-d4e17373.md#source-charts-docs-guides-themes-and-styling-md) for palette,
