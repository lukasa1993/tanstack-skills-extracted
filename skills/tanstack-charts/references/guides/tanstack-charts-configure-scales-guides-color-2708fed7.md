...
See also: `./tanstack-charts-design-responsive-charts-4db4e527.md#source-tanstack-charts-design-responsive-charts` § Common Mistakes
...
See also: `./tanstack-charts-design-responsive-charts-4db4e527.md#source-tanstack-charts-design-responsive-charts` and `./tanstack-charts-debug-and-verify-charts-2847fe26.md#source-tanstack-charts-debug-and-verify-charts` — final ranges depend on layout, and blank charts often expose scale-contract failures.
