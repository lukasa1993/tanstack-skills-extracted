...
Prerequisite: [Design A Chart](./tanstack-charts-design-a-chart-95ed488b.md).
Prerequisite: [Debug And Verify Charts](./tanstack-charts-debug-and-verify-charts-2847fe26.md).
...
See also: `./tanstack-charts-design-a-chart-95ed488b.md#source-tanstack-charts-design-a-chart` and `./tanstack-charts-debug-and-verify-charts-2847fe26.md#source-tanstack-charts-debug-and-verify-charts` — restate the analytical task and prove parity beyond screenshots.
