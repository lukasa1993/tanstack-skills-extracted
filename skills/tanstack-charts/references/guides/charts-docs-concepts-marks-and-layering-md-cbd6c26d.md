...
[Choosing a Chart](./charts-docs-guides-choosing-a-chart-md-c305fbfb.md#source-charts-docs-guides-choosing-a-chart-md). The
[Mark Reference](./charts-docs-reference-index-md-6fc2c6fc.md#source-charts-docs-reference-index-md) lists every channel and
...
Most custom visualizations should remain compositions of built-in marks plus application-prepared rows. Reach for a custom mark only when the geometry itself is new. See [Custom Marks and Renderers](./charts-docs-guides-custom-marks-and-renderers-md-88f45847.md#source-charts-docs-guides-custom-marks-and-renderers-md).
