...
| How does composition change over time?                   | A stacked or normalized area in [Stacked and Composed Charts](./charts-docs-examples-stacked-and-composition-md-e79a97ca.md#source-charts-docs-examples-stacked-and-composition-md) |
...
[Data and Channels](./charts-docs-concepts-data-and-channels-md-e25a7b78.md#source-charts-docs-concepts-data-and-channels-md) covers series grouping,
while [Legends and Color](./charts-docs-guides-legends-and-color-md-715f4e34.md#source-charts-docs-guides-legends-and-color-md) explains when a
...
[Data Transforms](./charts-docs-reference-transforms-md-6acdd0ab.md#source-charts-docs-reference-transforms-md) for rolling windows and reducers.
...
The [Overview](./charts-docs-overview-md-6bc1476c.md#source-charts-docs-overview-md) shows the complete
rendered Apple closing-price example. See
[Difference Marks](./charts-docs-reference-marks-difference-md-2f5d5bad.md#source-charts-docs-reference-marks-difference-md) for transposed
...
geometry. See [Line and Area Marks](./charts-docs-reference-marks-line-and-area-md-6c72b4c2.md#source-charts-docs-reference-marks-line-and-area-md) for
...
renderer. [Marks and Layering](./charts-docs-concepts-marks-and-layering-md-cbd6c26d.md#source-charts-docs-concepts-marks-and-layering-md) explains why
separate layers remain easier to update and extend.

## Production checks

- Preserve missing values when a gap is meaningful. The
  [Quick Start](./charts-docs-quick-start-md-b139d2e1.md#source-charts-docs-quick-start-md) demonstrates an explicit line gap.
...
- Preserve row IDs or unique positions across updates, and group series with
  ...
  [Dynamic Data and Animation](./charts-docs-guides-dynamic-data-and-animation-md-f2a556c9.md#source-charts-docs-guides-dynamic-data-and-animation-md).
- Let automatic layout measure tick labels, then verify the smallest container
  in [Responsive Charts](./charts-docs-guides-responsive-charts-md-aaa3953e.md#source-charts-docs-guides-responsive-charts-md).
- Use position, labels, or line treatment in addition to color when a
  distinction is essential. See [Accessibility](./charts-docs-guides-accessibility-md-3af2af82.md#source-charts-docs-guides-accessibility-md).
