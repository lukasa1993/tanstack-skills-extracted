...
- [Overview](./charts-docs-reference-rendering-and-export-md-ef854527--overview.md) — 1 KiB
- [Choose a renderer](./charts-docs-reference-rendering-and-export-md-ef854527--choose-a-renderer.md) — 3 KiB
...
<a id="react-native-adapter"></a>
<a id="renderchartsvg"></a>
<a id="canvas-renderer"></a>
<a id="svg-resources"></a>
<a id="reconcilechartsvg"></a>
<a id="animation-options"></a>
<a id="svg-serialization"></a>
