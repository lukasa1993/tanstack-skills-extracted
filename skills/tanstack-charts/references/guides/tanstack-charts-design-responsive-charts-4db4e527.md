...
See also: `./tanstack-charts-configure-scales-guides-color-2708fed7.md#source-tanstack-charts-configure-scales-guides-color` § Common Mistakes
...
See also: `./tanstack-charts-update-and-animate-charts-7f17ca0c.md#source-tanstack-charts-update-and-animate-charts` and `./tanstack-charts-debug-and-verify-charts-2847fe26.md#source-tanstack-charts-debug-and-verify-charts`

See also: `./tanstack-charts-ship-accessible-charts-94d273f3.md#source-tanstack-charts-ship-accessible-charts` and `./tanstack-charts-update-and-animate-charts-7f17ca0c.md#source-tanstack-charts-update-and-animate-charts` — initial size, label priority, and resize policy affect hydration, accessibility, and motion.
