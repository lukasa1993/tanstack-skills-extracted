...
Focus, interaction, and motion reference.

<a id="source-charts-docs-reference-focus-and-interaction-md"></a>

## Focus And Interaction

Source: `charts:docs/reference/focus-and-interaction.md`.
...
[Focus guide marks](./marks-spatial.md#source-charts-docs-reference-marks-focus-guide-md).
...
extension contracts in [Custom extensions](./rendering-composition-reference.md#source-charts-docs-reference-custom-extensions-md).

<a id="source-charts-docs-reference-motion-md"></a>

## Motion

Source: `charts:docs/reference/motion.md`.
