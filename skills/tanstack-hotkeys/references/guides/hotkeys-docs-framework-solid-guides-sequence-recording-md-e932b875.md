...
The shared options and exclusions are described in the [hotkey recording guide](./hotkeys-docs-framework-solid-guides-hotkey-recording-md-3f431779.md#source-hotkeys-docs-framework-solid-guides-hotkey-recording-md). The application owns reset, persistence, and any binding being edited; clearing never calls `onRecord([])`.
