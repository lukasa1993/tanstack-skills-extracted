...
Source: `hotkeys:docs/framework/react/guides/formatting-display.md`.
...
Source: `hotkeys:docs/framework/react/guides/hotkey-recording.md`.
...
Source: `hotkeys:docs/framework/react/guides/hotkeys.md`.
...
Source: `hotkeys:docs/framework/react/guides/key-state-tracking.md`.
...
Source: `hotkeys:docs/framework/react/guides/sequence-recording.md`.
...
Source: `hotkeys:docs/framework/react/guides/sequences.md`.
...
See the [Hotkeys Guide](./framework-react.md#source-hotkeys-docs-framework-react-guides-hotkeys-md) for details on declaration merging and introspecting registrations.
...
Source: `hotkeys:docs/framework/react/quick-start.md`.
...
- [Hotkeys Guide](./framework-react.md#source-hotkeys-docs-framework-react-guides-hotkeys-md) - Deep dive into `useHotkey` options and patterns
- [Sequences Guide](./framework-react.md#source-hotkeys-docs-framework-react-guides-sequences-md) - Multi-key sequence handling
- [Hotkey Recording Guide](./framework-react.md#source-hotkeys-docs-framework-react-guides-hotkey-recording-md) - Building shortcut customization UIs
- [Sequence Recording Guide](./framework-react.md#source-hotkeys-docs-framework-react-guides-sequence-recording-md)
- [Key State Tracking Guide](./framework-react.md#source-hotkeys-docs-framework-react-guides-key-state-tracking-md) - Real-time key state monitoring
- [Formatting & Display Guide](./framework-react.md#source-hotkeys-docs-framework-react-guides-formatting-display-md) - Platform-aware hotkey formatting
