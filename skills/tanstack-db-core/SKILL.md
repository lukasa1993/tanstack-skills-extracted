...
| Need to...                                       | Read                                                 |
| ------------------------------------------------ | ---------------------------------------------------- |
| Create a collection, pick an adapter, add schema | ../tanstack-db-core-collection-setup/SKILL.md                    |
| Query data with where, join, groupBy, select     | ../tanstack-db-core-live-queries/SKILL.md                        |
| Insert, update, delete with optimistic UI        | ../tanstack-db-core-mutations-optimistic/SKILL.md                |
| Build a custom sync adapter                      | ../tanstack-db-core-custom-adapter/SKILL.md                      |
| Persist collections to SQLite (offline cache)    | ../tanstack-db-core-persistence/SKILL.md                         |
| Preload collections in route loaders             | ../tanstack-db-meta-framework/SKILL.md                              |
| Add offline transaction queueing                 | ../tanstack-offline-transactions-offline/SKILL.md (in @tanstack/offline-transactions) |

For framework-specific hooks:

| Framework | Read                |
| --------- | ------------------- |
| React     | ../tanstack-react-db/SKILL.md   |
