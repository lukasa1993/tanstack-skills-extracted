---
name: tanstack-start-client-core-start-core-server-routes
...
metadata:
  ...
  tanstack-source-skill: "server-routes"
  tanstack-sources: "[\"TanStack/router:docs/start/framework/react/guide/server-routes.md\"]"
...
- [start-core/middleware](../tanstack-start-client-core-start-core-middleware/SKILL.md) — middleware for server routes
- [start-core/server-functions](../tanstack-start-client-core-start-core-server-functions/SKILL.md) — alternative for RPC-style calls
