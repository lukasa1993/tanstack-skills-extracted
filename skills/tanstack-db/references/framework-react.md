...
React DB adapter guidance.

<a id="source-tanstack-react-db"></a>

## React Db

Source: `tanstack-react-db`.
...
See ./live-queries.md#source-tanstack-db-core-live-queries for full includes rules (correlation conditions, nested includes, aggregates).
...
See ./foundations.md#source-tanstack-db-meta-framework for full preloading patterns.
...
The query builder looks like SQL but has constraints that SQL doesn't — equality joins only, orderBy required for limit/offset, no distinct without select. Agents write SQL-style queries that violate these constraints. See ./live-queries.md#source-tanstack-db-core-live-queries § Common Mistakes for all constraints.

See also: ./live-queries.md#source-tanstack-db-core-live-queries — for query builder API and all operators.

See also: ./mutations.md#source-tanstack-db-core-mutations-optimistic — for mutation patterns.

See also: ./foundations.md#source-tanstack-db-meta-framework — for preloading in route loaders.
