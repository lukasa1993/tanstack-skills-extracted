...
See also: ./tanstack-db-core-mutations-optimistic-9abd33bd.md#source-tanstack-db-core-mutations-optimistic — mutation handlers configured here execute during mutations.

See also: ./tanstack-db-core-custom-adapter-3b9cb5f2.md#source-tanstack-db-core-custom-adapter — for building your own adapter.
