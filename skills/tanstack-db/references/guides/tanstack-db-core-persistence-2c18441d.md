...
See also: ./tanstack-db-core-collection-setup-883eba1c.md#source-tanstack-db-core-collection-setup — for adapter selection and collection configuration.

See also: ./tanstack-offline-transactions-offline-6f208742.md#source-tanstack-offline-transactions-offline — for offline transaction queueing (complements persistence).
