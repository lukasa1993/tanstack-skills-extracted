...
Reactive live-query construction and operators.

<a id="source-tanstack-db-core-live-queries"></a>

## Live Queries

Source: `tanstack-db-core-live-queries`.
...
See also: ./framework-react.md#source-tanstack-react-db for React hooks (`useLiveQuery`, `useLiveSuspenseQuery`, `useLiveInfiniteQuery`).

### References

- [Query Operators Reference](./assets/tanstack-db-core-live-queries/references/operators.md) -- full signatures and examples for all operators, functions, and aggregates.

<a id="source-tanstack-db-playbook-tanstack-db-live-queries"></a>

## Tanstack Db Live Queries

Source: `tanstack-db-playbook-tanstack-db-live-queries`.
...
<a id="source-tanstack-db-skills-tanstack-db-live-queries"></a>

Exact duplicate of `tanstack-db-playbook-tanstack-db-live-queries`; use the preceding canonical content.
