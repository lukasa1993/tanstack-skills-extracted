---
name: tanstack-db-core-persistence
...
See also: ../tanstack-db-core-collection-setup/SKILL.md — for adapter selection and collection configuration.

See also: ../tanstack-offline-transactions-offline/SKILL.md — for offline transaction queueing (complements persistence).
