---
name: tanstack-start-client-core-start-core
description: "Core overview for TanStack Start: tanstackStart() Vite plugin, getRouter() factory, root route document shell (HeadContent, Scripts, Outlet), client/server entry points, routeTree.gen.ts, tsconfig configuration. Entry point for all Start skills."
license: "MIT"
metadata:
  internal: true
  ...
  tanstack-package-version: "1.170.25"
...
| Task                                             | Sub-Skill                                                                       |
| ------------------------------------------------ | ------------------------------------------------------------------------------- |
| Type-safe RPCs, data fetching, mutations         | [../tanstack-start-client-core-start-core-server-functions/SKILL.md](../tanstack-start-client-core-start-core-server-functions/SKILL.md)             |
| Request/function middleware, context, auth       | [../tanstack-start-client-core-start-core-middleware/SKILL.md](../tanstack-start-client-core-start-core-middleware/SKILL.md)                         |
| Server-side auth: sessions, cookies, OAuth, CSRF | [../tanstack-start-client-core-start-core-auth-server-primitives/SKILL.md](../tanstack-start-client-core-start-core-auth-server-primitives/SKILL.md) |
| Isomorphic execution, environment boundaries     | [../tanstack-start-client-core-start-core-execution-model/SKILL.md](../tanstack-start-client-core-start-core-execution-model/SKILL.md)               |
| REST API endpoints alongside app routes          | [../tanstack-start-client-core-start-core-server-routes/SKILL.md](../tanstack-start-client-core-start-core-server-routes/SKILL.md)                   |
| Hosting, SSR modes, prerendering, SEO            | [../tanstack-start-client-core-start-core-deployment/SKILL.md](../tanstack-start-client-core-start-core-deployment/SKILL.md)                         |
