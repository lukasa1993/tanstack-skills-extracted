---
name: tanstack-vue-table-getting-started
...
metadata:
  ...
  tanstack-sources: "[\"TanStack/table:docs/framework/vue/guide/migrating.md\",\"TanStack/table:examples/vue/basic-use-table\",\"TanStack/table:packages/vue-table/src/index.ts\"]"
