...
metadata:
  ...
  tanstack-package-version: "0.5.2"
...
| Survive reloads in the browser                  | ../tanstack-ai-core-client-persistence/SKILL.md in `@tanstack/ai` |
| Implement the store interfaces for your DB      | ../tanstack-ai-persistence-stores/SKILL.md                        |
| Multi-instance locks (separate from state)      | ../tanstack-ai-core-locks/SKILL.md in `@tanstack/ai`              |
...
| Cloudflare Workers + R2/D1 for generated media bytes | ../tanstack-ai-persistence-build-cloudflare-artifact-store/SKILL.md |
