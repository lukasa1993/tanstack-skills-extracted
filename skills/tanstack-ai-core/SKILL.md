...
metadata:
  ...
  tanstack-package-version: "0.52.1"
...
| Need to...                                        | Read                                          |
| ------------------------------------------------- | --------------------------------------------- |
| Build a chat UI with streaming                    | ../tanstack-ai-core-chat-experience/SKILL.md              |
| Survive a browser reload (no extra package)       | ../tanstack-ai-core-client-persistence/SKILL.md           |
| Add tool calling (server, client, or both)        | ../tanstack-ai-core-tool-calling/SKILL.md                 |
| Generate images, video, speech, or transcriptions | ../tanstack-ai-core-media-generation/SKILL.md             |
| Get typed JSON responses from the LLM             | ../tanstack-ai-core-structured-outputs/SKILL.md           |
| Choose and configure a provider adapter           | ../tanstack-ai-core-adapter-configuration/SKILL.md        |
| Implement AG-UI streaming protocol server-side    | ../tanstack-ai-core-ag-ui-protocol/SKILL.md               |
| Add analytics, logging, or lifecycle hooks        | ../tanstack-ai-core-middleware/SKILL.md                   |
| Coordinate multi-instance work with locks         | ../tanstack-ai-core-locks/SKILL.md                        |
| Connect to a non-TanStack-AI backend              | ../tanstack-ai-core-custom-backend-integration/SKILL.md   |
| Turn on/off debug logging, pipe into pino/winston | ../tanstack-ai-core-debug-logging/SKILL.md                |
