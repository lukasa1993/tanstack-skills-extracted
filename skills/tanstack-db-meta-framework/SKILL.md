...
See also: ../tanstack-react-db/SKILL.md, ../tanstack-vue-db/SKILL.md, ../tanstack-svelte-db/SKILL.md, ../tanstack-solid-db/SKILL.md, angular-db/SKILL.md — for framework-specific hook usage.
