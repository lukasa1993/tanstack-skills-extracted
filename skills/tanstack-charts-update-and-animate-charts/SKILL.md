---
name: tanstack-charts-update-and-animate-charts
description: "Update TanStack Charts through stable definition and datum identity, configure SVG motion, and preserve correctness during resize, interruption, streaming, and rolling windows. Load for reactive data, animation, reordering, enter/exit, or stale interaction state."
license: "MIT"
metadata:
  internal: true
...
See also: `../tanstack-charts-design-responsive-charts/SKILL.md` and `../tanstack-charts-debug-and-verify-charts/SKILL.md`

See also: `../tanstack-charts-build-chart-interactions/SKILL.md` and `../tanstack-charts-coordinate-charts-with-tanstack/SKILL.md` — stable mark and datum identity preserves controlled interaction across local, synchronized, and optimistic updates.
