---
name: tanstack-charts-design-responsive-charts
description: "Make TanStack Charts adapt to measured containers, information priority, guide margins, SSR initial width, and final plot bounds. Load for narrow dashboards, overflow, label density, responsive topology, or pixel-space layouts."
license: "MIT"
metadata:
  internal: true
...
See also: `../tanstack-charts-configure-scales-guides-color/SKILL.md` § Common Mistakes
...
See also: `../tanstack-charts-update-and-animate-charts/SKILL.md` and `../tanstack-charts-debug-and-verify-charts/SKILL.md`

See also: `../tanstack-charts-ship-accessible-charts/SKILL.md` and `../tanstack-charts-update-and-animate-charts/SKILL.md` — initial size, label priority, and resize policy affect hydration, accessibility, and motion.
