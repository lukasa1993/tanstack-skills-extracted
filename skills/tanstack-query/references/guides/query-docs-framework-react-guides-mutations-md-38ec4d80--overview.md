...
Even with just variables, mutations aren't all that special, but when used with the `onSuccess` option, the [Query Client's `invalidateQueries` method](https://github.com/TanStack/query/blob/e0f6c5542fc767f77a6cf1d5546591beae05f10f/docs/framework/react/reference/classes/QueryClient.md#invalidatequeries) and the [Query Client's `setQueryData` method](https://github.com/TanStack/query/blob/e0f6c5542fc767f77a6cf1d5546591beae05f10f/docs/framework/react/reference/classes/QueryClient.md#setquerydata), mutations become a very powerful tool.
