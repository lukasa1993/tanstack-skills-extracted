...
New to Lit Query? Start with [Installation](./query-docs-framework-lit-installation-md-e6a1af16.md#source-query-docs-framework-lit-installation-md) and [Quick Start](./query-docs-framework-lit-quick-start-md-2745312c.md#source-query-docs-framework-lit-quick-start-md) before wiring query controllers into your elements.
...
In Lit, subscribe to a query with [`createQueryController`](https://github.com/TanStack/query/blob/2969edf32f7e0c48e2a108d84712d6e01edfde21/docs/framework/lit/reference/functions/createQueryController.md):
...
For multiple queries that should run at the same time, see [Parallel Queries](https://github.com/TanStack/query/blob/2969edf32f7e0c48e2a108d84712d6e01edfde21/docs/framework/lit/guides/parallel-queries.md).
