...
In Lit, subscribe to a query with [`createQueryController`](https://github.com/TanStack/query/blob/19ccf2794b929e360234396682e64c047ab4bfda/docs/framework/lit/reference/functions/createQueryController.md):
...
For multiple queries that should run at the same time, see [Parallel Queries](https://github.com/TanStack/query/blob/19ccf2794b929e360234396682e64c047ab4bfda/docs/framework/lit/guides/parallel-queries.md).
