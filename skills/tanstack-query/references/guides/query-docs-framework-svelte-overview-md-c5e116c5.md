...
> Migrating from stores to the runes syntax? See the [migration guide](https://github.com/TanStack/query/blob/d4033eb1e5bdef3c8aa72a6cc614bcdd98b1ddca/docs/framework/svelte/migrate-from-v5-to-v6.md).
...
If you are using SvelteKit, please have a look at [SSR & SvelteKit](https://github.com/TanStack/query/blob/d4033eb1e5bdef3c8aa72a6cc614bcdd98b1ddca/docs/framework/svelte/ssr.md).
