...
<a id="source-query-docs-framework-react-guides-optimistic-updates-md"></a>

Release-matched documentation · `@tanstack/react-query@5.102.8`.

[Topic index](../framework-react.md) · [Source provenance](../SOURCES.md)

Runnable repository example: [React optimistic update with cancellation and rollback](../examples/react-optimistic.tsx). Tested with `@tanstack/react-query@5.102.8`, `react@19.2.8`. This MIT-licensed example is maintained here; the official guidance follows.
