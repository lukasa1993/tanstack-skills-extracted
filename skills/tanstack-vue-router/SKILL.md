...
metadata:
  ...
  tanstack-package-version: "1.170.23"
...
- [../tanstack-router-core/SKILL.md](../../../router-core/skills/router-core/SKILL.md) — all sub-skills for domain-specific patterns (search params, data loading, navigation, auth, SSR, etc.)
