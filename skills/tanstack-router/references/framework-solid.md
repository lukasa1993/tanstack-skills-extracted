...
This skill builds on router-core. Read [router-core](./foundations.md#source-tanstack-router-core) first for foundational concepts.
...
- [./foundations.md#source-tanstack-router-core](./foundations.md#source-tanstack-router-core) — all sub-skills for domain-specific patterns (search params, data loading, navigation, auth, SSR, etc.)
