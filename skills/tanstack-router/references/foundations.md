...
Router construction and type-safety.
...
| Task                                               | Sub-Skill                                                                    |
| -------------------------------------------------- | ---------------------------------------------------------------------------- |
| Validate, read, write, transform search params     | [./urls-navigation.md#source-tanstack-router-core-search-params](./urls-navigation.md#source-tanstack-router-core-search-params)               |
| Dynamic segments, splats, optional params          | [./urls-navigation.md#source-tanstack-router-core-path-params](./urls-navigation.md#source-tanstack-router-core-path-params)                   |
| Link, useNavigate, preloading, blocking            | [./urls-navigation.md#source-tanstack-router-core-navigation](./urls-navigation.md#source-tanstack-router-core-navigation)                     |
| Route loaders, SWR caching, context, deferred data | [./data-auth-errors.md#source-tanstack-router-core-data-loading](./data-auth-errors.md#source-tanstack-router-core-data-loading)                 |
| Auth guards, RBAC, beforeLoad redirects            | [./data-auth-errors.md#source-tanstack-router-core-auth-and-guards](./data-auth-errors.md#source-tanstack-router-core-auth-and-guards)           |
| Automatic and manual code splitting                | [./ssr-build-tooling.md#source-tanstack-router-core-code-splitting](./ssr-build-tooling.md#source-tanstack-router-core-code-splitting)             |
| 404 handling, error boundaries, notFound()         | [./data-auth-errors.md#source-tanstack-router-core-not-found-and-errors](./data-auth-errors.md#source-tanstack-router-core-not-found-and-errors) |
| Inference, Register, from narrowing, TS perf       | [./foundations.md#source-tanstack-router-core-type-safety](./foundations.md#source-tanstack-router-core-type-safety)                   |
| Streaming/non-streaming SSR, hydration, head mgmt  | [./ssr-build-tooling.md#source-tanstack-router-core-ssr](./ssr-build-tooling.md#source-tanstack-router-core-ssr)                                   |
