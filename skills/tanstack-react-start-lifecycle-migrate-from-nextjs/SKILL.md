---
name: tanstack-react-start-lifecycle-migrate-from-nextjs
...
metadata:
  ...
  tanstack-package-version: "1.168.53"
...
- [react-start](../tanstack-react-start/SKILL.md) — full React Start setup
