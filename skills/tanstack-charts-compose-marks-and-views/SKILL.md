---
name: tanstack-charts-compose-marks-and-views
description: "Translate semantic encodings into TanStack Charts marks, layers, annotations, facets, and coordinated views. Load when choosing marks, combining layers, assigning interaction-point ownership, or deciding whether a custom mark is justified."
license: "MIT"
metadata:
  internal: true
...
See also: `../tanstack-charts-build-chart-interactions/SKILL.md` and `../tanstack-charts-extend-tanstack-charts/SKILL.md` — layering determines point ownership, and native composition should be exhausted before extension.
