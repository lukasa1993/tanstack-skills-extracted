---
name: tanstack-table-core-row-selection
...
metadata:
  ...
  tanstack-source-skill: "row-selection"
  tanstack-sources: "[\"TanStack/table:docs/framework/react/guide/row-selection.md\",\"TanStack/table:packages/table-core/src/features/row-selection\",\"TanStack/table:examples/react/row-selection\"]"
