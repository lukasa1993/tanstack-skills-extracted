...
metadata:
  ...
  tanstack-package-version: "1.171.32"
...
- See also: **../tanstack-start-client-core-start-core-auth-server-primitives/SKILL.md** — server-side session cookies, OAuth state + PKCE, CSRF, password-reset hardening, rate limiting (the server half of authentication)
- See also: **../tanstack-start-client-core-start-core-middleware/SKILL.md** — `authMiddleware` factory pattern for protecting individual `createServerFn` calls
