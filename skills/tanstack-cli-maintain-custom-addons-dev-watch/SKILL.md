...
metadata:
  ...
  tanstack-requires: "[\"tanstack-cli-add-addons-existing-app\"]"
  tanstack-source-skill: "maintain-custom-addons-dev-watch"
...
See also: ../tanstack-cli-add-addons-existing-app/SKILL.md § Common Mistakes
