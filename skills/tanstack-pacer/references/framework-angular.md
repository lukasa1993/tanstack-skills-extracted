...
Source: `pacer:docs/framework/angular/adapter.md`.
...
For more on state and options per utility, see the guides (e.g. [Debouncing Guide](./debounce-throttle.md#source-pacer-docs-guides-debouncing-md), [Rate Limiting Guide](./rate-limiting.md#source-pacer-docs-guides-rate-limiting-md)).
