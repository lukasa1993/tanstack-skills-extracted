...
<a id="source-tanstack-cli-maintain-custom-addons-dev-watch"></a>

Published skill · `@tanstack/cli@0.71.0`.

[Topic index](../addon-authoring.md) · [Source provenance](../SOURCES.md)

Prerequisite: [Add Addons Existing App](./tanstack-cli-add-addons-existing-app-14730942.md).
...
See also: ./tanstack-cli-add-addons-existing-app-14730942.md#source-tanstack-cli-add-addons-existing-app § Common Mistakes
