...
| --- | --- | --- | --- | --- | --- |
| `tanstack-cli-add-addons-existing-app` | atomic | `projects-addons` | `@tanstack/cli` | `0.71.0` |  |
| `tanstack-cli-create-app-scaffold` | atomic | `projects-addons` | `@tanstack/cli` | `0.71.0` |  |
| `tanstack-cli-choose-ecosystem-integrations` | atomic | `ecosystem-discovery` | `@tanstack/cli` | `0.71.0` |  |
