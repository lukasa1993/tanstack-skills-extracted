---
name: tanstack-charts-configure-scales-guides-color
description: "Configure TanStack Charts domains, scale factories, axes, margins, legends, grouping, and paint without taking ownership of responsive ranges. Load for blank geometry, scale inference, color semantics, shared domains, ticks, labels, or guide layout."
license: "MIT"
metadata:
  internal: true
...
See also: `../tanstack-charts-design-responsive-charts/SKILL.md` § Common Mistakes

## References

- [Scale, guide, grouping, and color ownership](./references/scale-guide-ownership.md)

See also: `../tanstack-charts-design-responsive-charts/SKILL.md` and `../tanstack-charts-debug-and-verify-charts/SKILL.md` — final ranges depend on layout, and blank charts often expose scale-contract failures.
