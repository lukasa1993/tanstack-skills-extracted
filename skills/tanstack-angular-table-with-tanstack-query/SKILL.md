---
name: tanstack-angular-table-with-tanstack-query
...
metadata:
  ...
  tanstack-requires: "[\"tanstack-table-core-client-vs-server\",\"tanstack-angular-table-getting-started\",\"tanstack-angular-table-table-state\"]"
  tanstack-source-skill: "with-tanstack-query"
  tanstack-sources: "[\"TanStack/table:examples/angular/with-tanstack-query\",\"TanStack/table:docs/framework/angular/guide/table-state.md\",\"TanStack/table:docs/framework/angular/guide/pagination.md\"]"
