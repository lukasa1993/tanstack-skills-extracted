---
name: tanstack-highlight-configure-selective-highlighting
...
See also: `../tanstack-highlight-integrate-framework-code-blocks/SKILL.md` - framework adapters should consume the same selective registry.
...
See also: `../tanstack-highlight-extend-language-support/SKILL.md` - custom tokenizers delegate through `TokenizerContext`.

## References

- [Shipped languages, aliases, and imports](./references/languages.md)

See also: `../tanstack-highlight-integrate-framework-code-blocks/SKILL.md` - matching registries and package versions preserve hydrated output.
