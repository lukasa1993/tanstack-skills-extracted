...
Code Mode, MCP, and sandbox execution.
...
The same `lazyToolsConfig` option is accepted by plain `chat()` for its own lazy-tool discovery catalog (see `./tools-outputs-middleware.md#source-tanstack-ai-core-tool-calling`).
...
- See also: ./tools-outputs-middleware.md#source-tanstack-ai-core-tool-calling -- Code Mode is an alternative to standard tool calling for complex multi-step operations
- See also: ./chat-providers.md#source-tanstack-ai-core-chat-experience -- Code Mode requires handling custom events in useChat

<a id="source-tanstack-ai-mcp"></a>

## Ai Mcp

Source: `tanstack-ai-mcp`.

## `@tanstack/ai-mcp`

This skill covers the `@tanstack/ai-mcp` package. Read `./tools-outputs-middleware.md#source-tanstack-ai-core-tool-calling`
...
- See also: ./tools-outputs-middleware.md#source-tanstack-ai-core-tool-calling — MCP tools are ServerTools; all tool
  patterns (approval, lazy, client-side) apply.
- See also: ./chat-providers.md#source-tanstack-ai-core-chat-experience — wiring tools into `chat()`.

<a id="source-tanstack-ai-sandbox"></a>

## Ai Sandbox

Source: `tanstack-ai-sandbox`.
