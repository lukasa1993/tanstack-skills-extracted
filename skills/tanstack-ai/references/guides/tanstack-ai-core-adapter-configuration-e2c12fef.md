...
- [Overview](./tanstack-ai-core-adapter-configuration-e2c12fef--overview.md) — 1 KiB
- [Setup](./tanstack-ai-core-adapter-configuration-e2c12fef--setup.md) — 2 KiB
- [Core Patterns: 1. Adapter Selection](./tanstack-ai-core-adapter-configuration-e2c12fef--core-patterns-1-adapter-selection.md) — 6 KiB
...
- [Tension](./tanstack-ai-core-adapter-configuration-e2c12fef--tension.md) — 1 KiB
- [Cross-References](./tanstack-ai-core-adapter-configuration-e2c12fef--cross-references.md) — 1 KiB

<!-- Original source anchors retained for inbound links. -->
<a id="adapter-configuration"></a>
<a id="setup"></a>
<a id="core-patterns"></a>
<a id="1-adapter-selection"></a>
<a id="2-runtime-adapter-switching"></a>
<a id="3-configuring-reasoning-thinking"></a>
<a id="4-extending-adapters-with-custom-models"></a>
...
<a id="b-medium-wrong-api-key-environment-variable-name"></a>
<a id="references"></a>
<a id="tension"></a>
