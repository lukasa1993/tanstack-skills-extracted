...
- [Cross-References](./tanstack-ai-core-middleware-b87affa9--cross-references.md) — 2 KiB

<!-- Original source anchors retained for inbound links. -->
<a id="middleware"></a>
<a id="setup-analytics-tracking-middleware"></a>
<a id="hooks-reference"></a>
<a id="phase-values"></a>
<a id="onstructuredoutputconfig"></a>
<a id="core-patterns"></a>
<a id="pattern-1-analytics-and-logging-middleware"></a>
<a id="pattern-2-tool-interception-middleware"></a>
<a id="pattern-3-structured-output-middleware"></a>
<a id="pattern-4-multiple-middleware-composition"></a>
<a id="pattern-tool-call-budget-app-owned"></a>
<a id="built-in-toolcachemiddleware"></a>
<a id="server-state-persistence-withpersistence"></a>
<a id="authoritative-history-contract"></a>
<a id="backends"></a>
<a id="streamdurabilitysnapshot"></a>
<a id="resume-reconstruction-is-the-middlewares-job-server-authoritative-path"></a>
<a id="sandbox-file-event-hooks-sandbox-group"></a>
<a id="before-after-diff-lazy-git-backed-content-accessors"></a>
<a id="common-mistakes"></a>
<a id="a-medium-trying-to-modify-streamchunks-in-middleware"></a>
<a id="b-medium-middleware-exceptions-breaking-the-stream-in-onchunk-onconfig"></a>
