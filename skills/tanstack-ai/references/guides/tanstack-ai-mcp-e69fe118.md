...
Published skill · `@tanstack/ai-mcp@0.4.3`.
...
<a id="sse"></a>
<a id="stdio-node-only-import-from-stdio-subpath"></a>
<a id="custom-transport-escape-hatch"></a>
<a id="authentication"></a>
<a id="three-type-safety-modes"></a>
...
<a id="prompts"></a>
<a id="mcp-apps"></a>
<a id="static-widgets-uiresourcepart"></a>
<a id="interactive-apps-createmcpappcallhandler"></a>
<a id="client-side-usemcpappbridge-mcpappresource"></a>
<a id="codegen-cli"></a>
<a id="error-classes"></a>
<a id="complete-server-route-example"></a>
<a id="common-mistakes"></a>
<a id="a-high-closing-the-client-before-the-stream-finishes"></a>
