...
- See also: **./tanstack-ai-core-middleware-b87affa9.md#source-tanstack-ai-core-middleware** -- the middleware chain and capability plumbing
- See also: **`@tanstack/ai-persistence` skills** (`./tanstack-ai-persistence-2fec28cd.md#source-tanstack-ai-persistence` in that package) -- `ai-persistence/server` (state middleware) and `ai-persistence/build-cloudflare-adapter` (Durable Object lock recipe)
