...
| `tanstack-ai-persistence-build-custom-adapter` | atomic | `persistence-adapters` | `@tanstack/ai-persistence` | `0.4.1` |  |
| `tanstack-ai-persistence-build-drizzle-adapter` | atomic | `persistence-adapters` | `@tanstack/ai-persistence` | `0.4.1` |  |
| `tanstack-ai-persistence-build-prisma-adapter` | atomic | `persistence-adapters` | `@tanstack/ai-persistence` | `0.4.1` |  |
| `tanstack-ai-persistence-build-cloudflare-adapter` | atomic | `persistence-cloudflare` | `@tanstack/ai-persistence` | `0.4.1` |  |
| `tanstack-ai-persistence-build-cloudflare-artifact-store` | atomic | `persistence-cloudflare` | `@tanstack/ai-persistence` | `0.4.1` |  |
| `tanstack-ai-memory` | atomic | `memory` | `@tanstack/ai-memory` | `0.1.4` |  |
| `tanstack-ai-memory-hindsight` | atomic | `memory` | `@tanstack/ai-memory` | `0.1.4` |  |
| `tanstack-ai-memory-honcho` | atomic | `memory` | `@tanstack/ai-memory` | `0.1.4` |  |
| `tanstack-ai-memory-in-memory` | atomic | `memory` | `@tanstack/ai-memory` | `0.1.4` |  |
| `tanstack-ai-memory-mem0` | atomic | `memory` | `@tanstack/ai-memory` | `0.1.4` |  |
| `tanstack-ai-memory-redis` | atomic | `memory` | `@tanstack/ai-memory` | `0.1.4` |  |
| `tanstack-ai-code-mode` | atomic | `agent-runtimes` | `@tanstack/ai-code-mode` | `0.4.2` |  |
| `tanstack-ai-mcp` | atomic | `agent-runtimes` | `@tanstack/ai-mcp` | `0.3.3` |  |
| `tanstack-ai-sandbox` | atomic | `agent-runtimes` | `@tanstack/ai-sandbox` | `0.4.0` |  |
