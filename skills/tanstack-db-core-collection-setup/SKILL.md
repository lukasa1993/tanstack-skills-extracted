---
name: tanstack-db-core-collection-setup
...
See also: ../tanstack-db-core-mutations-optimistic/SKILL.md — mutation handlers configured here execute during mutations.

See also: ../tanstack-db-core-custom-adapter/SKILL.md — for building your own adapter.
