---
name: tanstack-charts-ship-accessible-charts
description: "Ship TanStack Charts with meaningful accessibility, deterministic SSR and hydration, correct adapter lifecycle, renderer and export choices, exact package subpaths, and explicit React Native validation."
license: "MIT"
metadata:
  internal: true
  ...
  tanstack-source-skill: "ship-accessible-charts"
  tanstack-sources: "[\"TanStack/charts:docs/guides/accessibility.md\",\"TanStack/charts:docs/guides/ssr-and-hydration.md\",\"TanStack/charts:docs/guides/exporting.md\",\"TanStack/charts:docs/framework/*/adapter.md\",\"TanStack/charts:packages/react-native-charts/README.md\"]"
...
See also: `../tanstack-charts-build-chart-interactions/SKILL.md` and `../tanstack-charts-extend-tanstack-charts/SKILL.md`
...
See also: `../tanstack-charts-debug-and-verify-charts/SKILL.md` — SSR, accessibility, renderer, and package claims need consumer-level evidence.
