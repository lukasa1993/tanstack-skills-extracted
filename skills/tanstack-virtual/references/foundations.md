...
<a id="source-virtual-docs-api-virtual-item-md"></a>

## Virtual Item

Source: `virtual:docs/api/virtual-item.md`.
...
Source: `virtual:docs/api/virtualizer.md`.
...
Source: `virtual:docs/installation.md`.
...
<a id="source-virtual-docs-introduction-md"></a>

## Introduction

Source: `virtual:docs/introduction.md`.
...
For chat, AI streams, logs, and other reverse feeds, see the [Chat guide](./measurement-feeds.md#source-virtual-docs-chat-md).
