...
Prerequisite: [Getting Started](./tanstack-lit-table-getting-started-592e9498.md).
Prerequisite: [Table State](./tanstack-lit-table-table-state-2569e6f4.md).

This section is an exact duplicate. Read [Overview in Create Table Hook](./tanstack-lit-table-create-table-hook-d83066bd.md).
