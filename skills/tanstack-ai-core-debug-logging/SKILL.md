---
name: tanstack-ai-core-debug-logging
...
metadata:
  ...
  tanstack-source-skill: "ai-core/debug-logging"
  tanstack-sources: "[\"TanStack/ai:docs/advanced/debug-logging.md\"]"
...
- See also: **../tanstack-ai-core-middleware/SKILL.md** — if you need to transform
