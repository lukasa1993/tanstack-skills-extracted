...
metadata:
  ...
  tanstack-source-skill: "devtools-event-client"
  tanstack-sources: "[\"packages/event-bus-client/src/plugin.ts\",\"docs/event-system.md\",\"docs/building-custom-plugins.md\"]"
  tanstack-type: "core"
---
