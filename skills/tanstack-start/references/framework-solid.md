...
Solid Start adapter guidance.

<a id="source-tanstack-solid-start"></a>

## Solid Start

Source: `tanstack-solid-start`.

## Solid Start (`@tanstack/solid-start`)

This skill builds on start-core. Read [start-core](./foundations.md#source-tanstack-start-client-core-start-core) first for foundational concepts.
...
- [solid-router](./router-ssr-tooling-adapters.md#source-tanstack-solid-router) — Solid Router hooks and components
