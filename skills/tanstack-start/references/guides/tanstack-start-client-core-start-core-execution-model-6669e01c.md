...
- [start-core/server-functions](./tanstack-start-client-core-start-core-server-functions-49d113b0.md#source-tanstack-start-client-core-start-core-server-functions) — the primary server boundary
- [start-core/deployment](./tanstack-start-client-core-start-core-deployment-9cda074c.md#source-tanstack-start-client-core-start-core-deployment) — deployment target affects execution
