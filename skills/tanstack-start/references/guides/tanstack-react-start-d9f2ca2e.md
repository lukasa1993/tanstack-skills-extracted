...
For React Server Components patterns, see [react-start/server-components](./tanstack-react-start-server-components-93d115ff.md#source-tanstack-react-start-server-components).
...
- [react-router](./tanstack-router-core-3c7fd849.md#source-tanstack-router-core) — React Router hooks and components
