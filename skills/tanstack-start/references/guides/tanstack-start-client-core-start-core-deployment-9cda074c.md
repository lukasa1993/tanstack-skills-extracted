...
> ```
>
> Or read `process.env.X` per-request inside `.handler()` / middleware `.server()`. See [Cloudflare's environment-variables docs](https://developers.cloudflare.com/workers/configuration/environment-variables/) and [start-core/execution-model](./tanstack-start-client-core-start-core-execution-model-6669e01c.md#source-tanstack-start-client-core-start-core-execution-model).
...
- [start-core/server-routes](./tanstack-start-client-core-start-core-server-routes-6852c613.md#source-tanstack-start-client-core-start-core-server-routes) — API endpoints for sitemaps, robots.txt
- [start-core/execution-model](./tanstack-start-client-core-start-core-execution-model-6669e01c.md#source-tanstack-start-client-core-start-core-execution-model) — SSR affects where code runs
