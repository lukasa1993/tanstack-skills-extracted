...
| --- | --- | --- | --- | --- | --- |
| `tanstack-start-client-core-start-core` | atomic | `foundations` | `@tanstack/start-client-core` | `1.170.30` |  |
| `tanstack-start-client-core-start-core-execution-model` | atomic | `foundations` | `@tanstack/start-client-core` | `1.170.30` |  |
| `tanstack-start-client-core-start-core-server-functions` | atomic | `server-runtime` | `@tanstack/start-client-core` | `1.170.30` |  |
| `tanstack-start-client-core-start-core-server-routes` | atomic | `server-runtime` | `@tanstack/start-client-core` | `1.170.30` |  |
...
| `tanstack-router-core-navigation` | atomic | `router-essentials` | `@tanstack/router-core` | `1.171.30` |  |
| `tanstack-router-core-not-found-and-errors` | atomic | `router-essentials` | `@tanstack/router-core` | `1.171.30` |  |
| `tanstack-router-core-path-params` | atomic | `router-essentials` | `@tanstack/router-core` | `1.171.30` |  |
| `tanstack-router-core-search-params` | atomic | `router-essentials` | `@tanstack/router-core` | `1.171.30` |  |
| `tanstack-router-core-type-safety` | atomic | `router-essentials` | `@tanstack/router-core` | `1.171.30` |  |
| `tanstack-router-core-code-splitting` | atomic | `router-ssr-tooling-adapters` | `@tanstack/router-core` | `1.171.30` |  |
| `tanstack-router-core-ssr` | atomic | `router-ssr-tooling-adapters` | `@tanstack/router-core` | `1.171.30` |  |
| `tanstack-router-plugin` | atomic | `router-ssr-tooling-adapters` | `@tanstack/router-plugin` | `1.168.38` |  |
| `tanstack-solid-router` | atomic | `router-ssr-tooling-adapters` | `@tanstack/solid-router` | `1.170.34` |  |
| `tanstack-virtual-file-routes` | atomic | `router-ssr-tooling-adapters` | `@tanstack/virtual-file-routes` | `1.162.0` |  |
| `tanstack-vue-router` | atomic | `router-ssr-tooling-adapters` | `@tanstack/vue-router` | `1.170.33` |  |
