---
name: tanstack-table-core-table-features
...
metadata:
  ...
  tanstack-source-skill: "table-features"
  tanstack-sources: "[\"TanStack/table:docs/guide/row-models.md\",\"TanStack/table:packages/table-core/src/types/TableFeatures.ts\",\"TanStack/table:packages/table-core/src/features/stockFeatures.ts\",\"TanStack/table:packages/table-core/src/core/table/constructTable.ts\"]"
