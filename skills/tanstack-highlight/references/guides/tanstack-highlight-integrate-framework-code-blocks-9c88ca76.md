...
Prerequisite: [Integrate Markdown Pipelines](./tanstack-highlight-integrate-markdown-pipelines-32cb443f.md).
...
See also: `./tanstack-highlight-configure-selective-highlighting-aee9011b.md#source-tanstack-highlight-configure-selective-highlighting` - build one selective isomorphic registry.
...
See also: `./tanstack-highlight-integrate-markdown-pipelines-32cb443f.md#source-tanstack-highlight-integrate-markdown-pipelines` - Remark and Rehype can avoid raw HTML.
...
See also: `./tanstack-highlight-integrate-markdown-pipelines-32cb443f.md#source-tanstack-highlight-integrate-markdown-pipelines` - fence helpers share block normalization.
...
See also: `./tanstack-highlight-configure-selective-highlighting-aee9011b.md#source-tanstack-highlight-configure-selective-highlighting` - SSR and client output require the same registry and package version.
