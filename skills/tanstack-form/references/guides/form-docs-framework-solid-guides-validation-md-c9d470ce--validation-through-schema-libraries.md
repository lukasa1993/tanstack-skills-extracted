...
> Validation will not provide you with transformed values. See [submission handling](./form-docs-framework-solid-guides-submission-handling-md-4cd820e1.md#source-form-docs-framework-solid-guides-submission-handling-md) for more information.
