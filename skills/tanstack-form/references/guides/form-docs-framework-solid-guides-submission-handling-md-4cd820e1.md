...
While Tanstack Form provides [Standard Schema support](./form-docs-framework-solid-guides-validation-md-c9d470ce.md#source-form-docs-framework-solid-guides-validation-md) for validation, it does not preserve the Schema's output data.
