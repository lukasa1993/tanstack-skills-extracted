...
[Topic index](../framework-preact-advanced.md) · [Source provenance](../SOURCES.md)
...
To use a form group in TanStack Form, you'll use `useForm` or [`useAppForm`](./form-docs-framework-preact-guides-form-composition-md-acac1a23.md#source-form-docs-framework-preact-guides-form-composition-md) to create a `form` variable, then reference its `FormGroup` component like you would a `Field`:
...
If you want to use [dynamic validation (`onDynamic`)](./form-docs-framework-preact-guides-dynamic-validation-md-6f2c4201.md#source-form-docs-framework-preact-guides-dynamic-validation-md) with a form group, do not rely on the `onDynamic` validator passed to `useForm`:
