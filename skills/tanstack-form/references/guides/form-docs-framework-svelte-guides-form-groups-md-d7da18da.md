...
To use a form group in TanStack Form, you'll use `createForm` or [`createAppForm`](./form-docs-framework-svelte-guides-form-composition-md-c121dab5.md#source-form-docs-framework-svelte-guides-form-composition-md) to create a `form` variable, then reference its `FormGroup` component like you would a `Field`:
...
If you want to use [dynamic validation (`onDynamic`)](./form-docs-framework-svelte-guides-dynamic-validation-md-16ecb3b4.md#source-form-docs-framework-svelte-guides-dynamic-validation-md) with a form group, do not rely on the `onDynamic` validator passed to `createForm`:
