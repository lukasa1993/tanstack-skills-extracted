...
> Validation will not provide you with transformed values. See [submission handling](./form-docs-framework-angular-guides-submission-handling-md-100620c8.md#source-form-docs-framework-angular-guides-submission-handling-md) for more information.
