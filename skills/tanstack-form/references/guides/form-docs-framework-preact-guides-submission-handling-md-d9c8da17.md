...
While Tanstack Form provides [Standard Schema support](./form-docs-framework-preact-guides-validation-md-8713dd87.md#source-form-docs-framework-preact-guides-validation-md) for validation, it does not preserve the Schema's output data.
