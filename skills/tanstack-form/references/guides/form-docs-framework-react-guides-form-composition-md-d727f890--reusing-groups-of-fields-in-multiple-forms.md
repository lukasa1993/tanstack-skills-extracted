...
Sometimes, a pair of fields are so closely related that it makes sense to group and reuse them — like the password example listed in the [linked fields guide](./form-docs-framework-react-guides-linked-fields-md-37f1a676.md#source-form-docs-framework-react-guides-linked-fields-md). Instead of repeating this logic across multiple forms, you can utilize the `withFieldGroup` higher-order component.
