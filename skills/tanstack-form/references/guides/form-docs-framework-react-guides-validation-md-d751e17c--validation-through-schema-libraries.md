...
> Validation will not provide you with transformed values. See [submission handling](./form-docs-framework-react-guides-submission-handling-md-75de4e64.md#source-form-docs-framework-react-guides-submission-handling-md) for more information.
