...
While Tanstack Form provides [Standard Schema support](./form-docs-framework-vue-guides-validation-md-13811ffa.md#source-form-docs-framework-vue-guides-validation-md) for validation, it does not preserve the Schema's output data.
