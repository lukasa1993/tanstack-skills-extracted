...
While Tanstack Form provides [Standard Schema support](./form-docs-framework-angular-guides-validation-md-50a0451b.md#source-form-docs-framework-angular-guides-validation-md) for validation, it does not preserve the Schema's output data.
