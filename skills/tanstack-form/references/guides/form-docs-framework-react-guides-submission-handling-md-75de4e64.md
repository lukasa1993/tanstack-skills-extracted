...
While Tanstack Form provides [Standard Schema support](./form-docs-framework-react-guides-validation-md-d751e17c.md#source-form-docs-framework-react-guides-validation-md) for validation, it does not preserve the Schema's output data.
