...
> For situations where you want to "react" to triggers, check out the [listener](./form-docs-framework-preact-guides-listeners-md-384a035d.md#source-form-docs-framework-preact-guides-listeners-md) API.
