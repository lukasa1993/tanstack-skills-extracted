...
As a result, we've developed [a philosophy around the library's usage](./form-docs-philosophy-md-1a773d34.md#source-form-docs-philosophy-md) that values scalability and long-term developer experience over short and sharable code snippets.
