...
> For situations where you want to "react" to triggers, check out the [listener](./form-docs-framework-react-guides-listeners-md-91abc662.md#source-form-docs-framework-react-guides-listeners-md) API.
