---
name: tanstack-start-client-core-start-core-deployment
...
> ```
>
> Or read `process.env.X` per-request inside `.handler()` / middleware `.server()`. See [Cloudflare's environment-variables docs](https://developers.cloudflare.com/workers/configuration/environment-variables/) and [start-core/execution-model](../tanstack-start-client-core-start-core-execution-model/SKILL.md).
...
- [start-core/server-routes](../tanstack-start-client-core-start-core-server-routes/SKILL.md) — API endpoints for sitemaps, robots.txt
- [start-core/execution-model](../tanstack-start-client-core-start-core-execution-model/SKILL.md) — SSR affects where code runs
