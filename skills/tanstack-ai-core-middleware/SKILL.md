...
metadata:
  ...
  tanstack-source-skill: "ai-core/middleware"
  tanstack-sources: "[\"TanStack/ai:docs/advanced/middleware.md\",\"TanStack/ai:docs/sandbox/observability.md\",\"TanStack/ai:docs/persistence/overview.md\"]"
...
concern (see ../tanstack-ai-core-chat-experience/SKILL.md resumability, not this middleware).
...
`../tanstack-ai-core-ag-ui-protocol/SKILL.md` for reading that chunk (and the opt-in
...
- See also: **../tanstack-ai-core-structured-outputs/SKILL.md** -- Separate finalization uses `onStructuredOutputConfig` for JSON-Schema transforms; native-combined schema transformation is not exposed through middleware
