---
name: tanstack-table-core-row-pinning
...
metadata:
  ...
  tanstack-source-skill: "row-pinning"
  tanstack-sources: "[\"TanStack/table:docs/framework/react/guide/row-pinning.md\",\"TanStack/table:packages/table-core/src/features/row-pinning\",\"TanStack/table:examples/react/row-pinning\"]"
