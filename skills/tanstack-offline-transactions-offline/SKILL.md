---
name: tanstack-offline-transactions-offline
...
metadata:
  ...
  tanstack-package-version: "1.0.53"
...
See also: ../tanstack-db-core-mutations-optimistic/SKILL.md — for the underlying mutation primitives.

See also: ../tanstack-db-core-collection-setup/SKILL.md — for setting up collections used with offline transactions.
