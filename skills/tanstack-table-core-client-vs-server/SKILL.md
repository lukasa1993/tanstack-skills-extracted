---
name: tanstack-table-core-client-vs-server
...
metadata:
  ...
  tanstack-source-skill: "client-vs-server"
  tanstack-sources: "[\"TanStack/table:docs/guide/row-models.md\",\"TanStack/table:packages/table-core/src/core/row-models/coreRowModelsFeature.utils.ts\",\"TanStack/table:examples/react/with-tanstack-query\"]"
